...
export const SidebarProfile = () => {
  ...
  return (
    <Container fluid className="w-100 d-flex flex-column py-5 vh-100 align-items-center" style={{ backgroundColor: "#f0f0f0" }}>
      ...
      <Container className="bg-light d-flex flex-column shadow p-3 mb-5 bg-body-tertiary rounded">
        ...
        <Nav.Link as={NavLink} to="/login" className="border-bottom p-3">
          <div className="d-flex gap-2">
            <Repeat size={24} />
            Trocas
          </div>
