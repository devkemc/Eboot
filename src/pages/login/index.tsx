            ...
            <Form onSubmit={handleSubmit(handleSubmitLogin)}>
              ...
              <Form.Group className="mb-3" controlId="loginSenha">
                ...
                <Form.Control type={viewPassword ? 'text' : 'password'}
                              placeholder="entre com sua senha" {...register("senha")} />

              </Form.Group>
              <Form.Group className="mb-3" controlId="manterConectado">
                <Form.Check type="checkbox" label="Mostrar senha" onChange={() => {
          ...
          <Col xs={12} sm={5}>
            <Form onSubmit={handleSubmit(handleSubmitFirstAccess)}>
              ...
              <Form.Group className="mb-3" controlId='criarContaEmail'>
                ...
                <Form.Control onChange={(event) => setCreatedUserEmail(event.target.value)} type="email"
